        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-last md:order-first">
              <img src={abaImg} alt={title} className="w-full h-auto rounded-lg shadow-lg" />
            </div>
            {/* Right: Title */}
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we believe that every child has the potential to learn,
                  communicate, and thrive. Some children, especially those with Autism Spectrum
                  Disorder (ASD) or behavioral and developmental challenges, may need structured,
                  evidence-based interventions to develop essential skills.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  ABA (Applied Behavior Analysis) Therapy is one of the most effective,
                  scientifically supported therapies for helping children acquire meaningful skills
                  and reduce behaviors that interfere with learning and social participation.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  ...
                  behavior. It uses structured teaching strategies, positive reinforcement, and
                  data-driven interventions to help children:
                </p>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  ABA focuses on breaking down complex skills into smaller, achievable steps and
                  reinforcing progress through rewards and encouragement.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  While it is widely associated with autism, ABA can also help children with
                  learning and behavioral challenges to reach developmental milestones.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Helping the child apply learned skills across different settings, people, and
                  situations.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Pre-academic concepts, counting, and problem-solving
                  </ContentListItem>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Reducing challenging behaviors such as aggression, tantrums, or self-injury
                  </ContentListItem>
                  <ContentListItem>
                    Replacing unwanted behaviors with functional alternatives
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya, ABA Therapy is individualized and child-focused:
                </p>
                <ul className="list-decimal list-inside space-y-2 text-lg text-gray-700">
                  <li>
                    Functional Behavioral Assessment (FBA) to understand strengths and challenges.
                  </li>
                  <li>Specific, measurable, and achievable goals based on the child’s needs.</li>
                  <li>
                    One-on-one or small group sessions using play, activities, and reinforcement.
                  </li>
                  <li>Parents are trained to reinforce learning at home and in daily routines.</li>
                  <li>
                    Progress is tracked using data collection and analysis to refine strategies.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Reduction of challenging or disruptive behaviors
                  </ContentListItem>
                  <ContentListItem>
                    Increased attention, focus, and learning readiness
                  </ContentListItem>
                  <ContentListItem>Strengthened parent-child interaction</ContentListItem>
                  <ContentListItem>
                    Better integration into school and community activities
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Parents are active participants in ABA therapy. At Suvatsalya, we guide parents
                  to:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Collaborate with therapists for goal-setting and progress review
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Child-centered, engaging, and play-based sessions
                  </ContentListItem>
                  <ContentListItem>
                    Integration with Speech Therapy, Occupational Therapy, and Special Education
                  </ContentListItem>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  At Suvatsalya, our goal is to help every child unlock their potential, communicate
                  effectively, and participate confidently in daily life.
                </p>
              </div>
            </div>
          </div>
