            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we believe that every child has the right to live, learn, and grow
                  with confidence. For some children, simple everyday activities — like holding a
                  spoon, buttoning a shirt, writing, or playing — can be challenging due to
                  developmental delays, sensory difficulties, or physical limitations.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  This is where Occupational Therapy (OT) plays a transformative role. Occupational
                  Therapy helps children develop the skills needed for daily living, independence,
                  and participation in school, home, and social life.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Occupational Therapy (OT) is a child-centered, evidence-based therapeutic approach
                  that focuses on helping children gain independence in daily life activities
                  through play, exercises, and skill-building tasks.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  The term “occupation” in children refers to their everyday activities — playing,
                  learning, socializing, eating, and self-care.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  An occupational therapist helps children build, regain, or strengthen the
                  physical, sensory, and cognitive abilities required for these activities. In
                  simple words, OT helps children do what they need and love to do — more easily and
                  independently.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Occupational Therapy benefits children with a wide range of developmental,
                  neurological, physical, or behavioral challenges, such as:
                </p>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Activities that strengthen small muscles of the hands and fingers. Helps in tasks
                  like writing, buttoning, cutting, feeding, and dressing.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  2. Gross Motor Skills
                </h4>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Enhances body strength, balance, and coordination. Improves posture, sitting
                  tolerance, and movement control.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  3. Sensory Integration
                </h4>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Helps children process and respond to sensory input (touch, sound, movement,
                  sight, smell). Especially beneficial for children who are over- or under-sensitive
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Builds independence in self-care routines: eating, bathing, dressing, grooming,
                  and toileting.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  5. Cognitive and Social Skills
                </h4>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Focuses on attention, memory, planning, and problem-solving. Encourages
                  interaction, play, and participation with peers and family.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Parents often notice subtle signs that their child struggles with day-to-day
                  tasks. You may consider an OT evaluation if your child:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Has difficulty holding a pencil, crayon, or spoon
                  </ContentListItem>
                  <ContentListItem>
                    Avoids touch, sound, or movement (or seeks too much of it)
                  </ContentListItem>
                  <ContentListItem>
                    Struggles with dressing, buttoning, or tying shoelaces
                  </ContentListItem>
                  ...
                  <ContentListItem>
                    Finds it hard to focus or follow multi-step instructions
                  </ContentListItem>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  Early identification and therapy can prevent these challenges from affecting your
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, our Occupational Therapy program is led by qualified therapists
                  trained in paediatric developmental care. We offer a play-based, individualized
                  approach that turns therapy into fun and learning.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Each session at Suvatsalya is designed to be engaging, interactive, and
                  goal-oriented. A typical session may include:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>Warm-up and movement activities</ContentListItem>
                  <ContentListItem>
                    Fine-motor games (puzzles, pegboards, clay play)
                  </ContentListItem>
                  ...
                  <ContentListItem>
                    Role-play for self-care (feeding, brushing, dressing)
                  </ContentListItem>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we believe parents are co-therapists. We train parents to continue
                  therapy activities at home for better consistency and faster improvement.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  We Guide Parents To:
                </h4>
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Reinforce fine-motor activities (drawing, stacking, picking)
                  </ContentListItem>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Occupational Therapy can make a lifelong impact on a child’s development. Some key
                  benefits include:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Enhanced sensory regulation and emotional control
                  </ContentListItem>
                  ...
                  <ContentListItem>
                    Better parent-child bonding through shared progress
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we combine scientific therapy with compassionate care. Our OT rooms
                  are equipped with child-friendly sensory tools, swings, tactile boards, therapy
                  balls, and adaptive aids designed to stimulate curiosity and comfort.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  We focus not just on treating symptoms — but on empowering each child to explore,
                  learn, and thrive in every environment.
                </p>
              </div>
