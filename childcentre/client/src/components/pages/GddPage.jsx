        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-last md:order-first">
              <img src={gddImg} alt={title} className="w-full h-auto rounded-lg shadow-lg" />
            </div>
            {/* Right: Title */}
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we understand that every child’s journey unfolds at their own pace.
                  Some children may take a little longer to reach milestones like walking, talking,
                  or learning — and that may be due to a condition known as Global Developmental
                  Delay (GDD).
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Early recognition and intervention can make a world of difference. With
                  compassionate care, structured therapies, and family guidance, children with GDD
                  can develop essential skills and move toward independence.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Global Developmental Delay (GDD) is a diagnosis given to children under 5 years of
                  age who show significant delays in two or more areas of development, such as:
                </p>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  In simple terms, GDD means that a child is developing slower than expected for
                  their age in several areas — but with early therapy and support, they can make
                  remarkable progress.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  GDD is diagnosed in children under 5 years, as it’s too early to assess full
                  intellectual functioning.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  If developmental delays persist beyond 5 years and affect learning and daily
                  functioning, the diagnosis may change to Intellectual Disability (ID).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Global Developmental Delay can result from various biological, genetic, or
                  environmental factors affecting the developing brain. In many cases, the exact
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  Each child’s condition is unique — understanding the root cause helps in planning
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Parents are often the first to notice when something feels “different.” Some
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  If multiple areas show delays, evaluation for Global Developmental Delay is
                  recommended.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya, diagnosis is a collaborative and child-friendly process, focused on
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  Our goal is not just to label — but to understand why the delay exists, which
                  areas need support, and how to build a personalized plan for growth.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  While GDD cannot be “cured,” timely and consistent intervention can help a child
                  reach their developmental potential. At Suvatsalya, we offer a multidisciplinary
                  intervention model, combining therapies tailored to each child’s developmental
                  profile.
                </p>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Manages hyperactivity, frustration, and emotional difficulties
                  </ContentListItem>
                  <ContentListItem>
                    Family counselling to promote positive parenting
                  </ContentListItem>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Regular medical check-ups for associated conditions
                  </ContentListItem>
                  <ContentListItem>
                    Nutritional guidance to support brain growth and overall health
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Parents are the child’s first and most consistent teachers. At Suvatsalya, we
                  emphasize parental involvement and guide families with practical home-based
                  strategies.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  Parenting Tips for GDD:
                </h4>
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Use picture cards, songs, and games for learning
                  </ContentListItem>
                  ...
                  <ContentListItem>
                    Collaborate with therapists for home carryover programs
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  The outlook for children with GDD depends on its cause and severity. With early
                  diagnosis and continuous therapy, many children show tremendous improvement — some
                  even catch up with peers over time.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Even when delays persist, children learn to adapt, communicate, and function
                  meaningfully in daily life with consistent support. At Suvatsalya, we believe that
              ...
              {/* Commitment */}
              <div>
                <h3 className="text-3xl font-semibold text-brand-blue mb-3">Our Commitment</h3>
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we walk hand-in-hand with families — helping each child unlock
                  their potential through care, compassion, and consistency. Our team of
                  specialists, therapists, and educators work collaboratively to ensure holistic
