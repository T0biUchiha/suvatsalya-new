        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-last md:order-first">
              <img src={adhdImg} alt={title} className="w-full h-auto rounded-lg shadow-lg" />
            </div>
            {/* Right: Title */}
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we believe that every child deserves to be understood — not judged.
                  One of the most common concerns parents share with us is when their child seems
                  “too restless,” “easily distracted,” or “unable to sit still.”
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  In many such cases, the underlying reason may be Attention-Deficit/Hyperactivity
                  Disorder (ADHD) — a condition that affects how the brain develops and manages
                  attention, activity, and self-control.
                </p>
              </div>

              {/* What is ADHD? */}
              <div>
                <h3 className="text-3xl font-semibold text-brand-blue mb-3">What is ADHD?</h3>
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Attention-Deficit/Hyperactivity Disorder (ADHD) is a neurodevelopmental condition
                  that impacts a child’s ability to focus, control impulses, and regulate energy
                  levels. It is not caused by bad parenting or laziness — it is a result of
                  differences in the way the brain develops and functions.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Children with ADHD may struggle to sit still, follow instructions, or complete
                  tasks, especially in structured settings like school. These behaviours are more
                  intense, frequent, and persistent than those typically seen in children of the
                  same age.
                </p>
              </div>
              ...
              {/* Types of ADHD */}
              <div>
                <h3 className="text-3xl font-semibold text-brand-blue mb-3">️ Types of ADHD</h3>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  The child has trouble focusing, gets easily distracted, forgets things, and often
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  The child is excessively active, talks a lot, interrupts others, or finds it hard
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  ADHD develops from a combination of genetic, biological, and environmental
                  factors:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>Family history of ADHD or related conditions</ContentListItem>
                  <ContentListItem>
                    Differences in brain structure or neurotransmitters (dopamine and
                    norepinephrine)
                  </ContentListItem>
                  <ContentListItem>Premature birth or low birth weight</ContentListItem>
                  <ContentListItem>
                    Prenatal exposure to tobacco, alcohol, or stress
                  </ContentListItem>
                  <ContentListItem>Early childhood trauma or neglect</ContentListItem>
                </ul>
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  It is important to understand that ADHD is nobody’s fault — not the parents’, not
                  the child’s.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya, our diagnostic process is comprehensive and child-friendly,
                  involving multiple steps to ensure accuracy and sensitivity:
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  For a diagnosis, symptoms must persist for at least six months, appear before age
                  twelve, and be observed in more than one setting (e.g., home and school).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  ADHD cannot be “cured,” but with the right approach, it can be effectively
                  managed. Our treatment philosophy focuses on empowering children and families
                  through a combination of therapies and strategies.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Helps children learn self-control, patience, and emotional regulation.
                  </ContentListItem>
                  <ContentListItem>
                    Parents are trained to use positive reinforcement and consistent routines.
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Improves attention, sensory processing, and fine motor skills.
                  </ContentListItem>
                  <ContentListItem>
                    Helps children manage impulsive movements and develop self-organization.
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Supports communication and comprehension issues, especially in younger children.
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  4. Educational and Classroom Support
                </h4>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>Individualized Education Plans (IEPs)</ContentListItem>
                  <ContentListItem>
                    Breaks during tasks, visual schedules, and structured instructions
                  </ContentListItem>
                  <ContentListItem>
                    Collaboration with teachers to create an ADHD-friendly classroom
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    When prescribed by a child psychiatrist. Medication decisions are made with
                    great care, only when clinically indicated.
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  6. Parent and Family Counselling
                </h4>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    ADHD affects the entire family. Through counselling, we help parents understand
                    the child’s challenges, reduce stress, and create a positive home environment.
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  With early identification and the right support, children with ADHD can grow into
                  focused, confident, and successful individuals. Many develop exceptional
                  creativity, innovation, and problem-solving abilities once their strengths are
                  nurtured.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  At Suvatsalya, we walk hand in hand with families — helping each child focus,
                  flourish, and find their rhythm.
                </p>
              </div>
