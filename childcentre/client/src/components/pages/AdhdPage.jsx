            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we believe that every child deserves to be understood — not judged. One of the most common concerns parents share with us is when their child seems “too restless,” “easily distracted,” or “unable to sit still.”
                </p>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  At Suvatsalya, we walk hand in hand with families — helping each child focus, flourish, and find their rhythm.
                </p>
              </div>
