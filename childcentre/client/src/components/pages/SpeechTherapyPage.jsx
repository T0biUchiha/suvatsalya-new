        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-last md:order-first">
              <img src={speechImg} alt={title} className="w-full h-auto rounded-lg shadow-lg" />
            </div>
            {/* Right: Title */}
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Speech and Language Therapy (SLT) is a specialized field focused on assessing,
                  diagnosing, and treating communication, speech, language, and swallowing disorders
                  in children and adults.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  For children, it plays a vital role in improving how they speak, understand,
                  express, and connect with the world around them. Early intervention can make a
                  remarkable difference in a child’s communication and overall development.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  Speech therapists (also called Speech-Language Pathologists or SLPs) work through
                  structured and play-based interventions to build language comprehension, speech
                  clarity, and social communication.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Problems with articulation (making specific sounds), voice, or fluency (e.g.,
                  stuttering).
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Difficulty understanding or using words in sentences. Includes both receptive
                  (understanding) and expressive (speaking) challenges.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  3. Social Communication Disorders:
                </h4>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Trouble using language appropriately in social contexts — common in children with
                  Autism Spectrum Disorder.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  4. Oral-Motor and Feeding Issues:
                </h4>
                <p className="text-lg text-gray-700 leading-relaxed">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Speech therapy sessions are designed according to the child’s developmental level
                  and individual needs. Therapists use engaging, play-based, and goal-oriented
                  techniques such as:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>Articulation drills for sound correction</ContentListItem>
                  <ContentListItem>
                    Language games to build comprehension and vocabulary
                  </ContentListItem>
                  <ContentListItem>
                    Picture cards and stories to improve sentence formation
                  </ContentListItem>
                  <ContentListItem>
                    Role-play activities to develop social communication
                  </ContentListItem>
                  <ContentListItem>
                    Oral-motor exercises to strengthen mouth muscles
                  </ContentListItem>
                  <ContentListItem>
                    Parent training sessions for home carryover and consistency
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Strengthens oral-motor control for speech and feeding
                  </ContentListItem>
                  <ContentListItem>
                    Supports academic readiness and classroom learning
                  </ContentListItem>
                  <ContentListItem>
                    Promotes overall emotional and social development
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Parents play a central role in speech therapy success. Speech therapists guide
                  parents to:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Continue language stimulation at home through daily interactions
                  </ContentListItem>
                  <ContentListItem>
                    Encourage verbal communication instead of gestures
                  </ContentListItem>
                  <ContentListItem>
                    Use reading, singing, and storytelling for language enrichment
                  </ContentListItem>
                  <ContentListItem>
                    Create a supportive, patient, and language-rich environment
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Individualized therapy plans designed for each child’s needs
                  </ContentListItem>
                  <ContentListItem>
                    Integration of play, movement, and visual learning for effective engagement
                  </ContentListItem>
                  <ContentListItem>
                    Close collaboration with parents, psychologists, and occupational therapists
                  </ContentListItem>
                  <ContentListItem>Regular progress tracking and feedback sessions</ContentListItem>
                </ul>
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  Our aim is to help every child find their voice, communicate confidently, and
                  build meaningful connections with their world.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Communication is the bridge between thoughts and the world — and every child
                  deserves the chance to cross it with confidence.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Through early intervention, structured therapy, and family support, Speech and
                  Language Therapy can transform a child’s life — helping them express, understand,
