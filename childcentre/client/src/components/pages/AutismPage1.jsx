          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-base text-gray-700 mb-4 leading-relaxed">
                As of 2025, the Centers for Disease Control and Prevention (CDC) says that about 1
                in 31 children aged 8 in the United States are diagnosed with Autism Spectrum
                Disorder (ASD). That's around 3.2% of children.
              </p>
              <p className="text-base text-gray-700 mb-8 leading-relaxed">
                Worldwide, the World Health Organization (WHO) says about 1 in 100 children may have
                ASD. This number can change based on how each country tests and reports it.
              </p>
              {/* Stats */}
            ...
            <div className="md:col-span-1 space-y-10">
              ...
              <div>
                <h2 className="text-3xl font-light text-gray-900 mb-4">
                  Understanding Autism Spectrum Disorder (ASD) At Suvatsalya Child Growth and
                  Development Centre
                </h2>
                <p className="text-gray-700 mb-4 leading-relaxed">
                  At Suvatsalya, we believe that every child sees the world in their own beautiful
                  way. Some children communicate, learn, or play differently — not because they
                  cannot, but because their brains process information uniquely. One such
                  developmental difference is called Autism Spectrum Disorder (ASD).
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Autism is not an illness; it is a neurodevelopmental condition that affects the
                  way a person communicates, socializes, and responds to the world. Early
                  understanding, acceptance, and support can make a world of difference for a child
                  on the spectrum.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  affects: Social interaction and communication, and Behavioral patterns, interests,
                  and sensory responses.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  The term “spectrum” means that each child has a unique combination of strengths
                  and challenges — no two individuals with autism are exactly alike. Some children
                  may require significant support in daily living, while others may live
                  independently but face subtle difficulties in social communication.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <StyledListItem>
                    Trouble understanding emotions, tone, or social cues
                  </StyledListItem>
                ...
                <ul className="space-y-2">
                  <StyledListItem>
                    Repetitive movements such as flapping, spinning, or rocking
                  </StyledListItem>
                  ...
                  <StyledListItem>
                    Difficulty adjusting to changes in environment or routine
                  </StyledListItem>
                </ul>
                <h4 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
                ...
                <ul className="space-y-2">
                  <StyledListItem>
                    Over- or under-sensitivity to sounds, lights, touch, textures, or smells
                  </StyledListItem>
                  <StyledListItem>
                    Unusual reactions to sensory experiences (covering ears, fascination with
                    lights, etc.)
                  </StyledListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <h4 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
                  By 3 Years and Above
                </h4>
                <ul className="space-y-2">
                  <StyledListItem>
                    Speech delay or unusual speech patterns (echolalia, scripting)
                  </StyledListItem>
                  <StyledListItem>Difficulty sharing interests or emotions</StyledListItem>
                  <StyledListItem>
                    Rigid routines or fixations on particular toys or activities
                  </StyledListItem>
                </ul>
                <p className="text-gray-700 mt-4 leading-relaxed">
                  Early identification allows for timely intervention — the earlier we start, the
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ASD does not have a single known cause. It is believed to arise from a combination
                  of genetic and environmental factors that affect early brain development.
                </p>
                <h4 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
                ...
                <ul className="space-y-2">
                  ...
                  <StyledListItem>
                    Prenatal exposure to toxins, infections, or stress
                  </StyledListItem>
                ...
                <div className="mt-4 p-4 bg-yellow-50 border-l-4 border-yellow-400">
                  ...
                  <p className="text-yellow-700">
                    Autism is not caused by vaccines, poor parenting, or emotional deprivation.
                    These are outdated myths.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  At Suvatsalya Child Growth and Development Centre, we follow a comprehensive,
                  multidisciplinary assessment model to understand the child’s developmental
                  profile.
                </p>
                <h4 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
                ...
                <ul className="space-y-2">
                  ...
                  <StyledListItem>
                    Clinical Observation (of communication, play, and social behavior)
                  </StyledListItem>
                  ...
                  <StyledListItem>
                    Speech, Occupational, and Psychological Evaluations for associated delays or
                    sensory issues
                  </StyledListItem>
                </ul>
                <p className="text-gray-700 mt-4 leading-relaxed">
                  A proper diagnosis is made only after observing symptoms across multiple settings
                  and confirming that behaviors significantly impact functioning.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <StyledListItem>
                    Hyperactivity or attention difficulties (ADHD overlap)
                  </StyledListItem>
                  <StyledListItem>Learning challenges or intellectual disability</StyledListItem>
                  <StyledListItem>
                    Emotional regulation difficulties (meltdowns, anxiety)
                  </StyledListItem>
                </ul>
                <p className="text-gray-700 mt-4 leading-relaxed">
                  Each child’s developmental profile is different — which is why personalized
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  At Suvatsalya, we focus on developing the child’s potential rather than “fixing”
                  them. Our multidisciplinary team designs individualized therapy programs suited to
                ...
                <h4 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
                  3. Behavioral Therapy (ABA-based and Play Therapy)
                </h4>
                <ul className="space-y-2 list-disc list-inside pl-6 text-gray-950">
                ...
                <h4 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
                  5. Parental Counselling and Guidance
                </h4>
                <ul className="space-y-2 list-disc list-inside pl-6 text-gray-950">
                ...
                <h4 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
                  6. Group Therapy and Social Skills Training
                </h4>
                <ul className="space-y-2 list-disc list-inside pl-6 text-gray-950">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Parents play the most crucial role in supporting their child’s development. Here
                  are some tips that make a big difference:
                </p>
                <ul className="space-y-2">
                  <StyledListItem>
                    Maintain consistent routines for meals, sleep, and therapy
                  </StyledListItem>
                  <StyledListItem>
                    Use visual schedules and cues to aid understanding
                  </StyledListItem>
                  ...
                  <StyledListItem>
                    Avoid comparing your child to others — focus on progress, not perfection
                  </StyledListItem>
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  With early intervention, children with autism can make significant progress in
                  communication, behavior, and independence. Many children go on to attend
                  mainstream schools, form friendships, and develop fulfilling lives.
                </p>
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Autism does not define a child’s future — it simply describes one aspect of who
                  they are.
                </p>
                <p className="text-gray-700 mb-4 leading-relaxed">
                  At Suvatsalya, we believe that with love, patience, and the right support, every
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <StyledListItem>
                    Comprehensive developmental assessment (DP4, ISAA, CARS)
                  </StyledListItem>
                  <StyledListItem>Speech and language therapy</StyledListItem>
                  <StyledListItem>
                    Occupational and sensory integration therapy
                  </StyledListItem>_ <StyledListItem>Behavioral and play therapy</StyledListItem>
              ...
              <ul className="space-y-6">
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      This therapy helps fix problem behavior and teaches good habits through
                      rewards. Early support for the therapist can significantly enhance a kid's
                      learning outcomes.
                    </p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      This helps children improve hand control, thinking, doing daily tasks, and
                      feeling good through simple activities.
                    </p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      This helps children speak clearly and learn language so they can talk and
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      This therapy helps children move better, get stronger, improve balance and
                      reach full physical ability.
                    </p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      This supports children who need different ways to learn that regular
                      classrooms may not offer. It helps them become more independent and do well in
                      studies.
                    </p>
                  </div>
                </li>
      ...
      <section className="w-full bg-white py-16 md:py-24">
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl font-light text-gray-900 mb-8">FAQ'S</h2>
              <div className="space-y-4">
                <FaqItem title="Can children with ASD become normal as they grow?">
                  <p>
                    Yes. With the right help and therapy, many children improve a lot. Some children
                    have very mild autism and may not even show signs later.
                  </p>
                </FaqItem>
                <FaqItem title="Who should I talk to for help?">
                  <p>
                    You can start by talking to your child's paediatrician. They can check your
                    child and refer you to a specialist, like a developmental paediatrician, child
                    neurologist, or a psychologist at a centre like Suvatsalya.
                  </p>
                </FaqItem>
                <FaqItem title="Can autism come later in childhood?">
                  <p>
                    Most signs of autism appear by age 2 or 3. Sometimes, a child may seem to
                    develop typically and then regress (lose skills). In other cases, signs might be
                    very subtle and not become noticeable until the child faces more complex social
                    demands in school.
                  </p>
                </FaqItem>
              </div>
