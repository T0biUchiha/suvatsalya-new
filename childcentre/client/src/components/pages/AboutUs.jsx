    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="order-last md:order-first">
              <h2 className="text-4xl md:text-5xl font-semibold text-brand-blue mb-8">About Us</h2>
              <p className="text-base text-gray-700 mb-4 leading-relaxed">
                Suvatsalya Child Growth and Development Centre is a nurturing space dedicated to the
                holistic development of every child. Founded with the vision to bridge compassion
                and understanding in child care, the centre provides individualized support that
                helps children learn, grow, and thrive at their own pace.
              </p>
              <p className="text-base text-gray-700 mb-4 leading-relaxed">
                Our multidisciplinary team of developmental paediatricians, paediatric neurologist,
                paediatric ophthalmologist, paediatric orthopaedician, paediatric ENT specialist,
                clinical psychologists, special educators, occupational and speech therapists works
                collaboratively to address developmental, behavioural, emotional, and learning
                needs. At Suvatsalya, we combine scientific expertise with empathy to create an
                inclusive, child-friendly environment where potential blossoms naturally.
              </p>
              <p className="text-base text-gray-700 leading-relaxed">
                We believe in nurturing strengths, celebrating milestones, and empowering families
                throughout the journey of growth and discovery. Suvatsalya — a complete family
                solution for child development, learning, and emotional well-being.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-last md:order-last">
              ...
              <p className="text-base text-gray-700 leading-relaxed">
                To create an inclusive, compassionate, and growth-oriented environment where every
                child — regardless of ability or challenge — is empowered to reach their fullest
                potential. We envision a world where early intervention, empathy, and family support
                come together to build confident, capable, and emotionally balanced individuals.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="order-last md:order-first">
              ...
              <ul className="list-disc list-inside space-y-4 text-base text-gray-700 leading-relaxed">
                <li>
                  <strong className="text-gray-800">To provide</strong> comprehensive,
                  evidence-based care that supports the cognitive, emotional, physical, and social
                  development of children.
                </li>
                <li>
                  <strong className="text-gray-800">To offer</strong> personalized therapy and
                  learning programs designed to meet each child&apos;s unique needs and strengths.
                </li>
                <li>
                  <strong className="text-gray-800">To empower</strong> families through
                  counselling, education, and collaboration, fostering a supportive network around
                  every child.
                </li>
                <li>
                  <strong className="text-gray-800">To create</strong> a safe, inclusive, and
                  child-friendly space where growth is celebrated and progress is nurtured with
                  compassion.
                </li>
              </ul>
            </div>
      ...
      <section className="w-full bg-white py-12 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
            id="team"
            className="text-4xl md:text-5xl font-semibold text-brand-blue mb-16 text-center"
          >
            Our Founder
          </h2>
              ...
              bio={
                <>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700">
                    <li>
                      Early identification &amp; intervention in neurodevelopmental challenges
                    </li>
          ...
          <div className="max-w-4xl mx-auto mt-10">
            <div className="relative bg-brand-cream rounded-xl p-8 md:p-10 border-l-4 border-brand-teal">
              <span className="absolute -top-4 left-8 text-6xl leading-none text-brand-teal/30 font-heading select-none">
                &ldquo;
              </span>
              <h3 className="text-2xl font-semibold text-brand-blue mb-5">
                A Message from the Founder
              </h3>
              <p className="text-base text-gray-600 italic mb-5">
                &ldquo;Every child is not meant to fit into the world as it is &mdash; sometimes the
                world must learn how to meet the child.&rdquo;
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-3">
                When parents come to Suvatsalya, they seek clarity, reassurance, and a path forward.
                This centre was created to provide exactly that &mdash; a structured, compassionate
                space where children are understood beyond labels and supported with purpose.
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-3">
                With a foundation in Special Education and Clinical Psychology, and guided by
                disciplined leadership, my vision for Suvatsalya is simple: integrate scientific
                insight with empathy-driven care to build strong developmental foundations.
              </p>
              <p className="text-base text-gray-700 leading-relaxed mb-3">
                We do not rush children to fit timelines.
                <br />
              ...
              <p className="mt-6 text-sm font-semibold text-brand-teal">
                &mdash; Mr. Sharad Shukla, Director &amp; Founder
              </p>
            </div>
          </div>
          ...
          <h2
            id="board"
            className="text-4xl md:text-5xl font-semibold text-brand-blue mb-10 mt-20 text-center"
          >
            Board of Advisors
          </h2>
          ...
          <div className="space-y-6">
              ...
              bio={
                <>
                  <ul className="list-disc list-inside space-y-1 mb-4 text-gray-700">
                    ...
                    <li>
                      Medical Education &ndash; Himalayan Institute of Medical Sciences, Dehradun
                    </li>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700">
                    ...
                    <li>
                      High-risk newborn follow-up (as defined by the American Academy of Paediatrics
                      &mdash; including preterm babies, low birth weight, birth asphyxia, neonatal
                      seizures, and NICU-admitted infants)
                    </li>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative bg-brand-cream rounded-xl p-8 md:p-10 border-l-4 border-brand-teal">
                ...
                <p className="text-base text-gray-700 leading-relaxed mb-3">
                  Every child&apos;s development tells a story &mdash; and early understanding can
                  shape its direction.
                </p>
                <p className="text-base text-gray-700 leading-relaxed mb-3">
                  In my years of working with children and families, I have seen how timely
                  identification and structured intervention can significantly influence long-term
                  outcomes. Developmental concerns, whether related to speech, attention, behaviour,
                  or motor skills, deserve clarity, not uncertainty.
                </p>
                <p className="text-base text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, our approach is rooted in evidence-based practice and
                  multidisciplinary collaboration. We focus not only on diagnosis, but on designing
                  individualized care pathways that strengthen developmental foundations.
                </p>
                <p className="text-base text-gray-700 leading-relaxed mb-3">
                  I strongly believe that parents are essential partners in this journey. With the
                  right guidance, structured planning, and compassionate support, children can move
                  forward with confidence.
                </p>
                <p className="text-base text-gray-700 leading-relaxed">
                  Every child deserves early understanding, informed care, and the opportunity to
                  reach their fullest potential.
                </p>
                <p className="mt-6 text-sm font-semibold text-brand-teal">
                  &mdash; Dr. Swati Chhabra, Developmental Paediatrician
                </p>
              </div>
            </div>
              ...
              bio={
                <>
                  <ul className="list-disc list-inside space-y-1 mb-4 text-gray-700">
                    ...
                    <li>
                      Former Assistant Professor &ndash; University of Delhi, Manipal University,
                      Ch. Bansi Lal University
                    </li>
                    <li>
                      Clinical Experience &ndash; NIMHANS Bengaluru | Lok Nayak Hospital (New Delhi)
                      | IGMC Shimla
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700">
                    <li>
                      Neurodevelopmental Disorders (Autism Spectrum Disorder, ADHD, Learning
                      Disabilities)
                    </li>
              ...
              bio={
                <>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700">
                    ...
                    <li>
                      Strong focus on innovation, user experience &amp; performance optimization
                    </li>
                  </ul>
                </>
              }
