        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-last md:order-first">
              <img src={cpImg} alt={title} className="w-full h-auto rounded-lg shadow-lg" />
            </div>
            {/* Right: Title */}
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we believe that every child deserves the chance to move, grow, and
                  thrive — at their own pace. When a child struggles with movement, muscle control,
                  or coordination due to an early brain injury or developmental difference, it may
                  be a condition known as Cerebral Palsy (CP).
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Cerebral Palsy is not a disease, but a neuromotor condition that affects posture,
                  muscle tone, and movement. With timely therapy, assistive care, and family
                  support, children with CP can lead active, independent, and fulfilling lives.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Cerebral Palsy (CP) is a group of permanent movement and posture disorders caused
                  by damage to the developing brain, either during pregnancy, birth, or early
                  infancy.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  The term “cerebral” refers to the brain, and “palsy” means weakness or problems
                  with muscle control.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Although the brain injury is non-progressive (it does not worsen with time), the
                  physical challenges may change as the child grows — making ongoing therapy and
                  support essential.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Cerebral Palsy occurs when the developing brain is injured or doesn’t develop
                  normally. This can happen before, during, or shortly after birth.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  Possible Causes Include:
                </h4>
                <h5 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Maternal health issues (thyroid disorders, high blood pressure)
                  </ContentListItem>
                </ul>
                <h5 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Low birth weight or multiple births (twins/triplets)
                  </ContentListItem>
                </ul>
                <h5 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Cerebral Palsy is classified based on the type of movement disorder and which part
                ...
                <ul className="list-disc list-inside pl-6 space-y-2">
                  ...
                  <ContentListItem>
                    Spastic Quadriplegia: affects all four limbs and trunk
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Involuntary, uncontrolled movements (writhing or twisting)
                  </ContentListItem>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Unsteady walking and difficulty with fine motor skills
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">4. Mixed Type</h4>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Combination of two or more movement types (commonly spastic + dyskinetic)
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Orthopedic complications (scoliosis, joint deformities)
                  </ContentListItem>
                </ul>
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  Each child’s profile is unique — the severity and combination of symptoms vary
                  widely.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Doesn’t reach out or use both sides of body equally
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  Early identification allows for timely intervention, which can significantly
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya, diagnosis involves a multidisciplinary approach — combining
                  medical, developmental, and neurological evaluations.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  The focus is not just on confirming CP but also on understanding the child’s
                  strengths and therapy needs.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  While the brain injury cannot be reversed, early and holistic therapy can greatly
                  improve muscle control, balance, communication, and independence. At Suvatsalya,
                  we design individualized intervention plans based on the child’s specific needs.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">1. Physiotherapy</h4>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Core therapy for improving muscle strength, balance, and movement
                  </ContentListItem>
                  ...
                  <ContentListItem>
                    Use of supportive devices like braces or walkers
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Enhances fine motor and daily living skills (feeding, dressing, writing)
                  </ContentListItem>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Helps with communication, swallowing, and oral-motor control
                  </ContentListItem>
                  <ContentListItem>
                    May include AAC (Augmentative and Alternative Communication) for non-verbal
                    children
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  4. Special Education and Cognitive Support
                </h4>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>Individualized learning plans</ContentListItem>
                  <ContentListItem>
                    Focus on functional academics and adaptive skills
                  </ContentListItem>
                  <ContentListItem>
                    Coordination with schools for inclusive education
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Managing frustration, self-esteem, and social-emotional development
                  </ContentListItem>
                  <ContentListItem>Family counselling and parent training</ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  6. Medical and Orthopedic Management
                </h4>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Muscle relaxant medications (e.g., Baclofen) if required
                  </ContentListItem>
                  <ContentListItem>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Orthoses, wheelchairs, standing frames, or adaptive seating systems
                  </ContentListItem>
                  <ContentListItem>
                    Technology-based aids for communication and mobility
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Parents are central to the child’s progress. At Suvatsalya, we empower parents
                  with practical, daily-life strategies:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Continue home exercise programs taught by therapists
                  </ContentListItem>
                  <ContentListItem>Encourage independent attempts, even if slow</ContentListItem>
                  <ContentListItem>
                    Use adaptive utensils or supportive chairs for feeding
                  </ContentListItem>
                  <ContentListItem>
                    Provide emotional encouragement — not overprotection
                  </ContentListItem>
                  <ContentListItem>
                    Maintain therapy consistency and track milestones
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Cerebral Palsy is a lifelong condition, but it does not define the child’s future.
                  With early, consistent therapy and an enabling environment, most children can
                  walk, communicate, learn, and live meaningful lives.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  At Suvatsalya, our team of therapists, educators, and psychologists works together
                  to nurture every child’s abilities — helping them move toward independence,
                  confidence, and joy.
                </p>
              </div>
