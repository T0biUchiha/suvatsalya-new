            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we believe that every child deserves the chance to move, grow, and thrive — at their own pace. When a child struggles with movement, muscle control, or coordination due to an early brain injury or developmental difference, it may be a condition known as Cerebral Palsy (CP).
                </p>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya, diagnosis involves a multidisciplinary approach — combining medical, developmental, and neurological evaluations.
                </p>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  At Suvatsalya, our team of therapists, educators, and psychologists works together to nurture every child’s abilities — helping them move toward independence, confidence, and joy.
                </p>
              </div>
