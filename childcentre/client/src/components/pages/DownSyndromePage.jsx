        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-last md:order-first">
              <img src={dsImg} alt={title} className="w-full h-auto rounded-lg shadow-lg" />
            </div>
            {/* Right: Title */}
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we believe that every child is unique, capable, and deserving of
                  love, learning, and opportunity.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Down Syndrome is not a disease — it is a genetic condition that affects how a
                  child grows and learns. With the right guidance, therapies, and inclusive support,
                  children with Down Syndrome can live healthy, happy, and independent lives.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Down Syndrome (also known as Trisomy 21) is a genetic condition that occurs when a
                  child is born with an extra copy of chromosome 21. Typically, humans have 46
                  chromosomes (23 pairs), but in Down Syndrome, there are 47 chromosomes — the
                  additional chromosome changes the way the brain and body develop.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  This extra genetic material affects physical features, cognitive abilities, and
                  developmental pace — but every child with Down Syndrome has their own strengths,
              ...
              <div>
                ...
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  1. Trisomy 21 (Nondisjunction) — ~95% cases
                </h4>
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Most common and occurs randomly during cell division.
                  </ContentListItem>
                </ul>

                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  2. Translocation Down Syndrome — ~3–4% cases
                </h4>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    The extra chromosome 21 attaches (translocates) to another chromosome.
                  </ContentListItem>
                  <ContentListItem>
                    Can be inherited from a parent carrying a balanced translocation.
                  </ContentListItem>
                </ul>

                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  3. Mosaic Down Syndrome — ~1–2% cases
                </h4>
                <ul className="list-disc list-inside space-y-2">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Down Syndrome is not caused by anything parents did or didn’t do. It occurs due to
                  random chromosomal changes during early cell division.
                </p>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Genetic Translocation: One parent may carry a translocated chromosome.
                  </ContentListItem>
                  <ContentListItem>
                    Previous Child with Down Syndrome: Slightly increases risk for subsequent
                    pregnancies.
                  </ContentListItem>
                </ul>
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  Despite these factors, most babies with Down Syndrome are born to younger mothers
                  because younger women have more pregnancies overall.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  These features do not define the child’s abilities — each child’s personality,
                  talents, and learning potential are unique.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Children with Down Syndrome usually have mild to moderate intellectual disability,
                  with strengths in:
                </p>
                <ul className="list-disc list-inside space-y-2">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4 mb-4">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  With early intervention, these delays can be minimized and compensated through
                  targeted therapies and consistent home support.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Children with Down Syndrome may experience certain medical challenges, though not
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  With regular medical checkups and supportive therapies, most of these challenges
                  can be well-managed.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Blood tests and ultrasound can suggest higher risk.
                  </ContentListItem>
                  <ContentListItem>
                    Diagnostic tests like Amniocentesis, CVS (Chorionic Villus Sampling), or NIPT
                    (Non-Invasive Prenatal Testing) confirm diagnosis.
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Based on physical signs and chromosomal analysis (karyotype) confirming extra
                    chromosome 21.
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya, we focus on early developmental stimulation and family-centred
                  care. Our evaluation process includes:
                </p>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  Each child’s strengths and challenges are mapped to create a personalized therapy
                  plan.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  While Down Syndrome cannot be cured, early and continuous intervention helps
                  children achieve developmental milestones and independence.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">1. Physiotherapy</h4>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Improves muscle tone, posture, balance, and motor coordination
                  </ContentListItem>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Enhances fine motor skills (grasping, feeding, dressing)
                  </ContentListItem>
                  <ContentListItem>
                    Improves sensory processing and self-help abilities
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Addresses speech clarity, comprehension, and social communication
                  </ContentListItem>
                  <ContentListItem>
                    May include AAC (Augmentative and Alternative Communication) tools
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  4. Special Education
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Tailored learning methods to support memory, language, and functional academics
                  </ContentListItem>
                  <ContentListItem>
                    Encourages inclusion in mainstream schools with support
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Addresses attention, motivation, and emotional regulation
                  </ContentListItem>
                  <ContentListItem>
                    Family counselling for parental confidence and stress management
                  </ContentListItem>
                </ul>
                <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">6. Medical Care</h4>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Regular cardiac, thyroid, vision, and hearing check-ups
                  </ContentListItem>
                  <ContentListItem>
                    Nutritional guidance and general health monitoring
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Parents play the most vital role in a child’s growth. At Suvatsalya, we guide
                  parents with simple, daily-life activities to promote progress:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>Encourage play-based learning</ContentListItem>
                  <ContentListItem>
                    Use music, gestures, and visuals for communication
                  </ContentListItem>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Children with Down Syndrome today live longer, healthier lives than ever before —
                  often into their 60s or 70s, thanks to better medical care and early education.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  They can attend regular schools, pursue careers, participate in community life,
                  and form meaningful relationships when given opportunities for inclusion.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya, our multidisciplinary team provides:
                </p>
                <ul className="list-disc list-inside space-y-2">
              ...
              {/* Philosophy */}
              <div>
                <h3 className="text-3xl font-semibold text-brand-blue mb-3">Our Philosophy</h3>
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we see ability in every child. We believe that with compassion,
                  patience, and professional care — every child can learn, communicate, and blossom.
                </p>
              </div>
