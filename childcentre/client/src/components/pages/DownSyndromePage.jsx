            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  At Suvatsalya, we believe that every child is unique, capable, and deserving of love, learning, and opportunity.
                </p>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya, we focus on early developmental stimulation and family-centred care. Our evaluation process includes:
                </p>
