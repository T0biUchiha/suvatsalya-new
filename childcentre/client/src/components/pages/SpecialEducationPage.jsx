            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Special Education is a tailored educational approach designed to meet the unique
                  learning needs of children with developmental, intellectual, physical, or
                  emotional challenges. It uses individualized teaching methods, adaptive tools, and
                  structured learning plans to help every child reach their full potential.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  At Suvatsalya, we believe that every child can learn — they just need the right
                  support, pace, and environment. Our Special Education program bridges the gap
                  between a child's current abilities and their developmental goals.
                </p>
              </div>
              ...
              <div>
                ...
                <h4 className="text-2xl font-semibold text-gray-800 mt-4 mb-2">
                  1. Academic Skills
                </h4>
                <ul className="list-disc list-inside space-y-2">
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Functional communication for everyday situations
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Our special educators use a variety of research-backed methods to make learning
                  effective and engaging:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Individualized Education Plans (IEPs) based on each child's assessment
                  </ContentListItem>
                  <ContentListItem>
                    Multisensory teaching using visual, auditory, and tactile inputs
                  </ContentListItem>
                  <ContentListItem>
                    Task analysis — breaking skills into small, manageable steps
                  </ContentListItem>
                  <ContentListItem>
                    Play-based and activity-based learning for younger children
                  </ContentListItem>
                  <ContentListItem>
                    Structured routines to build predictability and comfort
                  </ContentListItem>
                  <ContentListItem>
                    Assistive technology and adaptive tools where needed
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Our Special Education program at Suvatsalya is designed to work in close
                  coordination with other therapies — including Speech Therapy, Occupational
                  Therapy, and ABA — for a holistic developmental approach.
                </p>
                <h4 className="text-2xl font-semibold text-gray-800 mt-4 mb-2">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <ContentListItem>
                    Builds foundational academic and pre-academic skills
                  </ContentListItem>
                  <ContentListItem>
                    Improves attention, memory, and cognitive functioning
                  </ContentListItem>
                  <ContentListItem>
                    Enhances social interaction and classroom behavior
                  </ContentListItem>
                  ...
                  <ContentListItem>
                    Prepares children for mainstream or supported schooling
                  </ContentListItem>
                  <ContentListItem>
                    Empowers parents with strategies for continued learning at home
                  </ContentListItem>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Parents are essential partners in the Special Education journey. We guide parents
                  to:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <ContentListItem>
                    Celebrate small achievements to build motivation
                  </ContentListItem>
                  <ContentListItem>
                    Collaborate with educators and therapists for consistent progress
                  </ContentListItem>
                </ul>
                <p className="text-lg text-gray-700 leading-relaxed mt-3">
                  At Suvatsalya, our goal is to help every child learn, grow, and succeed — at their
                  own pace, in their own way.
                </p>
              </div>
            </div>
          </div>
