        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8 text-lg text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-2xl font-bold text-brand-blue mb-3">Appointments and Communication</h3>
                <ul className="list-disc list-inside space-y-2">
              ...
              <div>
                ...
                <p>
                  ...
                  You can also review our <Link to="/policies" className="text-brand-teal underline">privacy policy</Link>.
                </p>
              </div>
