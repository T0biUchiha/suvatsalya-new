          ...
          <div className="max-w-6xl mx-auto">
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  Autism Spectrum Disorder (ASD) is a neurodevelopmental disorder that affects: Social interaction and communication, and Behavioral patterns, interests, and sensory responses.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya, we follow a comprehensive, multidisciplinary assessment model to understand the child’s developmental profile.
                </p>
