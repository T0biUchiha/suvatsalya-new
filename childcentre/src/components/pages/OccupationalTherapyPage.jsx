            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  At Suvatsalya Child Growth and Development Centre, we believe that every child has the right to live, learn, and grow with confidence. For some children, simple everyday activities — like holding a spoon, buttoning a shirt, writing, or playing — can be challenging due to developmental delays, sensory difficulties, or physical limitations.
                </p>
