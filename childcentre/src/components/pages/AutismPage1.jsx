...
_                  <StyledListItem>Behavioral and play therapy</StyledListItem>
      ...
      <section className="w-full bg-pink-50 py-16 md:py-24">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <FaqItem title="Who should I talk to for help?">
                  <p>You can start by talking to your child's pediatrician. They can check your child and refer you to a specialist, like a developmental pediatrician, child neurologist, or a psychologist at a centre like Suvatsalya.</p>
                </FaqItem>
